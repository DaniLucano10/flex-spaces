...
const Price = () => (
  <section
    className="pt-12 pb-16 bg-[#FFEADD]"
    aria-labelledby="planes-heading"
  >
    <div className="w-[85%] mx-auto px-4 text-center">
      <h2
        id="planes-heading"
        className="text-3xl font-extrabold text-[#943315] mb-10"
      >
          ...
          ({
            ...
            >
              <header className="flex flex-col md:flex-row items-center md:items-center md:justify-between mb-4">
                ...
                <p className="text-[#943315] font-extrabold mt-2 md:mt-0">
                  {price}
                </p>
              </header>
