    ...
    <section className="pb-4 pt-16">
      ...
      <div className="w-[90%] mx-auto text-center mt-4">
        <div className="relative w-full h-28 md:h-64 overflow-hidden">
          <Image
            src="/images/servicios/auditorio/servicios-auditorio-banner.webp"
          ...
          <div className="absolute inset-0 flex items-center justify-start px-10">
            <h1
              className="text-white text-3xl md:text-5xl font-bold md:text-start"
              data-aos="fade-left"
            >
              Auditorio
            </h1>
      ...
      <div className="w-[85%] mx-auto md:mt-4 text-justify space-y-6 mt-8">
        <p className="text-lg text-[#313131]">
          Espacios adaptados hasta 40 personas (sillas individuales). Con equipo
          tecnológico para el ponente. <br /> Además, contamos con un área común
          para coffee break.
        </p>
        ...
        <div>
          ...
          <ul className="list-disc pl-5 text-base text-[#313131] leading-relaxed space-y-1 ml-2">
            <li>Sillas solas o sillas con mesas (según se requiera)</li>
            <li>Proyector y ecrán</li>
