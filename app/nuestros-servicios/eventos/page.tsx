...
const galleryImages = [
  {
    src: "/images/servicios/eventos-corporativos/eventos-galeria-1.jpg",
    alt: "Vista frontal del auditorio con sillas y proyector",
  },
  {
    src: "/images/servicios/eventos-corporativos/eventos-galeria-2.jpg",
    alt: "Auditorio con iluminación ambiental y pantalla encendida",
  },
  {
    src: "/images/servicios/eventos-corporativos/eventos-galeria-3.webp",
    alt: "Vista lateral del auditorio mostrando el equipo tecnológico",
  },
  {
    src: "/images/servicios/eventos-corporativos/eventos-galeria-4.jpg",
    alt: "Área común para coffee break junto al auditorio",
  },
  {
    src: "/images/servicios/eventos-corporativos/eventos-galeria-5.jpg",
    alt: "Pizarra blanca con accesorios en el auditorio",
  },
  {
    src: "/images/servicios/eventos-corporativos/eventos-galeria-6.jpg",
    ...
    <section className="pb-4 pt-16">
      ...
      <div className="w-[90%] mx-auto text-center mt-4">
        <div className="relative w-full h-28 md:h-64 overflow-hidden">
          <Image
            src="/images/servicios/eventos-corporativos/servicios-evento-banner.webp"
          ...
          >
            <h1 className="text-white text-3xl md:text-5xl font-bold md:text-start">
              Sala de eventos <br /> corporativos
            </h1>
          </div>
        </div>
      </div>
      ...
      <div className="w-[85%] mx-auto md:mt-4 text-justify space-y-6 mt-8">
        <p className="text-lg text-[#313131]">
          Espacios adaptados según el número de personas. Manejamos una amplia
          gama dee posibilidades para el desarrollo de la mejor experiencia
          corporativa. Contáctanos para conocer más detalle de nuestros
          servicios completos.
        </p>
        ...
        <div>
          ...
          <ul className="list-disc pl-5 text-base text-[#313131] leading-relaxed space-y-1 ml-2">
            <li>Mesas y sillas personales (a medida)</li>
            <li>Pizarra acrílica y accesorios</li>
            <li>Proyector y Ecran dedicado</li>
            <li>Equipo Laptop para capacitor</li>
            <li>Internet con Wi-Fi Industrial</li>
            <li>Baño de Damas y Caballeros</li>
            <li>Área libre compartida para Coffee Break</li>
            <li>Micrófono y parlantes</li>
            <li>Zona de Almuerzo dedicado</li>
